...
| :------- | :----------------------------------------: | :--------: | :------------------------------------------------------------------------ |
| Backup  | [Backup system](https://github.com/CHRaclette/Backup-system) |  [GitHub](https://github.com/An0n-00/FileSync)   | `PowerShell` `Intellij Idea Ultimate` `Visual Studio Code` |
